Arability::Application.routes.draw do
  ...
  scope "/admin" do
    ...
    match "/delete_subscription_model"=>"admin#delete_subscription_model", :as => "delete_subscription_model"
    ...
    match "/:category_id/edit_category"=>"admin#edit_category", :as => "edit_category"
    put "/:category_id/update_category" => "admin#update_category", :as => "update_category"

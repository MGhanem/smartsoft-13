class Vote < ActiveRecord::Base
  ...
  def validate_gamer_exists
    ...
    errors.add(:gamer_id,"this gamer_id doesn't exist") if 
    valid_gamer == nil
  end
  ...
  def validate_synonym_exists
    ...
    errors.add(:synonym_id,"this synonym_id doesn't exist") if 
    valid_synonym == nil
  end
  ...
  def validate_voting_for_new_keyword
    ...
    check = Keyword.where("id NOT IN( 
      ...
      errors.add(:keyword_id,"this gamer voted for this keyword before") if 
      !check  
  end
